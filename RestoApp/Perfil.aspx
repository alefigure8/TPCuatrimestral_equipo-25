    ...
    <div class="row d-flex" style="justify-content:center">
        ...
        <div class="col-6 text-white bg-dark" style="width:400px; border-radius:5px; padding:10px;padding-left:20px;padding-right:20px;">
            ...
            <div class="row d-flex" style="justify-content:center;">
             ...
             <div style="background-color:darkgrey; border-radius:5px; width:180px; height:170px; padding:10px;">
       ...
       <div class="row" >
            ...
            <div class="col-3" >
                ...
                <div class="col-6">
                   ...
                   <asp:LinkButton ID="BtnModificarPass" runat="server" BorderColor="#797c81" style="margin-left: -5px;" OnClick="BtnModificarPass_Click" class="btn btn-outline-dark"><i class="fa-solid fa-pen" style="color: #797c81;"></i></asp:LinkButton>
                        </div>
                   </div>
